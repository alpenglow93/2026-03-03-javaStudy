...
{
	public void preparedStatement()				// SQL문장
	{
		System.out.println("SELECE 문장 전송 => 데이터 검색");
	}
...
class DB2
{
	// 라이브러리 => 추상 / 일반
	// 객체 생성 => new
	//Calendar cal = Calendar.getInstance();	// new 없이 객체가 생성되면 abstract
}
