 ...
 * 		2. 배열 초기화
 * 			= 선언과 동시에 초기화
 * 			int[] arr = {1, 2, 3, 4, 5};	// 명시적 초기화	(미리 값을 알고 있는 경우)
 ...
 * 			= 인덱스 번호를 이용하여 데이터 관리는 쉽다
 * 			= 고정적 / 같은 데이터형만 묶을 수 있다
 * 				컬렉션 / 클래스
 * 			= 선언을 하면 => 연속적으로 메모리 공간 생성 => 인덱스 번호 사용이 가능 (공간의 크기가 동일해야해 같은 데이터형만 사용이 가능)
 * 			= 배열명은 stack 공간에 저장(주소) / 실제 데이터는 heap에 저장
 * 				int[] arr;
...
public class 문자열배열_1 {
	...
	public static void main(String[] args) {
		...
		// 1. 반복문 사용이 안된다 => 반복문은 변수명이 1개일때 사용 가능
