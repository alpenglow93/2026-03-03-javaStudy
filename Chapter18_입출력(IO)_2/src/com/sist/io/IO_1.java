 ...
 * 			String : equals(), length(), trim(), substring(), split(),
 * 					valueOf(), replace(), replaceAll(), indexOf(), lastIndexOf()
 * 			Math : ceil(), random()
 * 			Wrapper
 ...
 * 							=> 문자 읽기 / 문자 쓰기
 * 		바이트스트림
 * 상위클래스		InputStream		/		OutputStream
 * 구현클래스		FileInputStream			FileOutputStream
 * 		문자스트림
 * 상위클래스		Reader			/		Writer
 * 구현글래스		FileReader				FileWriter
 * 		보조스트림
 * 				BufferedInputStream	/	BufferedOutputStream
 * 				BufferdReader		/	BufferedWritter
 * 		객체스트림
...
public class IO_1 {
	...
	public static void main(String[] args) {
		...
		try 
		{
			...
			System.out.println("수정일: "+sdf.format(new Date(file.lastModified())));	// long형이기 때문에 SimpleDateForamt을 이용
