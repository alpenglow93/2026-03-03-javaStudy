...
public class Collection_2 {
	...
	public static void main(String[] args) {
		...
		ArrayList list2 = new ArrayList(list.subList(1, 4)); // subList(start,end)
		list2.add(10);
		list2.add(11);
		list2.add(12);		
		...
		Collections.sort(list);	// 정렬할땐 Collections
		for(Object obj:list)
		{
			System.out.println(obj);
		}
		 ...
		 * 	retainAll() : 두 개의 list에 공통 데이터 추출
		 * 	Collections.sort() => 정렬
		 * 	------------------------------- 표준화 => 개발자가 동일하게 사용 
		 * 
		 */
