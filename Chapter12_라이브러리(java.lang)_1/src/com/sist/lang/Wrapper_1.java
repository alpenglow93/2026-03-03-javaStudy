 ...
 * 	int ii = i.vaule();
 * 	--------------------
 * 	Integer i = 10;	// 원래는 위처럼 써야하지만 이처럼 쓸 수 있게 만들어짐 
 * 					// 클래스에 실제 값을 주입 (AutoBoxing)
 * 	int ii = i;	// 기본형에 클래스 객체 주입 (UnBoxing)
 * 	
 * 
 */
...
//		System.out.println(k+m);
		...
		System.out.println(0b1010);	// 이진법 숫자 1010을 10진법으로 출력 => 0b 붙이기
		/*
		 * --- --- ---
		 * 	0   0   0
		 * rwx w-x x-w
		 * 	4   4   4	chmod 755 (권한을 줘라)
		 * 
		 */
