 ...
 * 			상속을 내리는 클래스 : double
 * 			상속을 받은 클래스 : int
 * 		*** 모든 클래스는 Object 상속을 받는다 (최상위 클래스)
 * 		=> 이미 만들어진 클래스의 변수/메소드를 받아서 새로운 기능의 확장된 클래스를 만든다
 ...
 * 	Animal a = new Dog();		// 변수: Animal / 메소드 : Dog
 * 	// 1. 변수 => 클래스형
 * 	// 2. 메소드 => 생성자
 * 	// 3. => 여러개의 클래스를 한 개로 통합 
...
public class 재사용_3 {
	...
	public static void main(String[] args) {
		...
		pig.eat();
		System.out.println("============");
		Animal a = new Dog();	// 하나의 객체를 생성해서 주소값만 저장해 사용
		a.eat();
		a = new Pig();
		a.eat();
		a = new Cat();
